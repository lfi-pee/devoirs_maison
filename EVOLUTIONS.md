...
## Le réservoir d'inscription n'avait jamais été confronté à une mesure : il en manque 21 %
...
> qu'il manque **0,59 M de personnes sur 2,84 M attendues**.

| Statut | Détail |
| ------ | ------ |
| ✅ Fait | **Le solde a maintenant un juge : `validation_non_inscription.py`.** Deux contraintes, qu'aucun réglage interne ne peut satisfaire par construction. **(1) L'identité nationale** : sommée sur toutes les communes, la mal-inscription s'annule exactement — chaque mal-inscrit·e est retranché·e là où il ou elle réside et ajouté·e là où il ou elle est inscrit·e — donc le solde national **doit** valoir la non-inscription pure, 2,84 M ([Insee Première n°1986](https://www.insee.fr/fr/statistiques/7766966), présidentielle 2022). **(2) La forme départementale** : la figure 4 de la même étude publie, pour 100 départements **de résidence** (le titre de la feuille tranche le sens de la ventilation), la part des personnes non inscrites dans leur commune de résidence ; un département qui exporte ses inscriptions doit afficher un solde plus positif. Le test porte sur les inscrit·es de la **présidentielle 2022**, scrutin de référence de l'étude, quand le site publie sur le registre 2024 : on compare ce qui est comparable, pas ce qui est affiché. |
| ✅ Vérifié | **Le signal est réel.** Spearman **0,475** entre le solde départemental et la mesure INSEE en métropole (p < 1e-6) : le solde dit bien quelque chose du terrain, ce qui n'allait pas de soi pour une soustraction entre deux sources qui ne se parlent pas. |
| ⚠️ Limite mesurée | **Et il est faux d'un décalage, toujours dans le même sens.** Total national **2,25 M contre 2,84 M** : **−21 %**. La droite d'ajustement coupe l'axe à **−0,063** là où la comptabilité l'attend vers **+0,058** — 12 points d'écart, sous tous les départements à la fois. C'est une seule et même chose : la **contamination des listes**, des inscrit·es qui ne sont dans la population résidente de personne (Français·es de l'étranger sur liste communale, radiations en retard). Elle n'est pas modélisée, et c'est elle, pas la nationalité ni les tranches d'âge, qui porte l'essentiel de l'erreur. |
| ✅ Corrigé | **La part de nationalité française est enfin mesurée sur les majeur·es.** `part_fr` était calculée sur **toute** la population, mineur·es compris, et servait pourtant à ramener `pop18` au corps électoral potentiel — un biais que EVOLUTIONS.md documentait comme « de l'ordre du point, non mesurable, compensé ». Il l'est maintenant : [NAT1](https://www.insee.fr/fr/statistiques/8202752) croise nationalité et âge à la commune (et à l'arrondissement PLM), seule table INSEE à le faire sous le département. `part_fr18` pondère la part de Français·es par les tranches adultes ; `part_fr` reste le repli pour les **234 communes** que NAT1 ne couvre pas. |
| ⚠️ Limite mesurée | **Ce correctif ne rachète pas le chiffre, et le test le dit.** Au national il ne vaut rien — 49,10 M de majeur·es français·es contre 49,02 M, **84 000 personnes, 0,17 %**. Sa valeur est **géographique** : en **Seine-Saint-Denis**, département le plus étranger de France et jusqu'ici pire écart du pays, l'erreur tombe de **+8,6 à +7,0 points**. C'est le **seul** des quatre grands écarts que la nationalité explique. Le tableau de bord bouge à peine (Spearman 0,481 → 0,475, dispersion des résidus 3,15 → 3,06 points) : on garde le correctif parce que c'est la bonne grandeur, pas parce qu'il résout quoi que ce soit. |
| ⚠️ Non vérifié | **Les Ardennes, +7,3 points, sans explication.** C'est le département **le moins mal-inscrit de France** (10,8 %) et il affiche un solde de 8,0 % — il est désormais notre plus gros écart, devant la Seine-Saint-Denis. Ni la nationalité, ni l'âge, ni la mobilité n'en rendent compte. Tant que ce n'est pas compris, tout modèle de contamination ajusté par-dessus incorporerait l'anomalie au lieu de la corriger. |
| ⚠️ Limite assumée | **L'outre-mer casse la relation et sort de l'ajustement.** Guadeloupe : **23,6 %** côté INSEE, **−11,1 %** côté solde. Ses listes portent une diaspora sans équivalent métropolitain. Les DOM sont mesurés et affichés, mais l'ajustement porte sur la métropole seule — les inclure fait tomber le Spearman de 0,48 à 0,41. Mayotte est hors champ de l'étude INSEE, d'où **100 départements** appariés et non 101. |
